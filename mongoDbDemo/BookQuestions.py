...
st.title("Ask me a question about the book")  # Text input field for the user to enter a topic  
 
# Prompt the user to enter a question

def answerQuestion(question,  vectorStore):
...
if question:   
    with st.spinner("Asking chatGPT"):
        answer=answerQuestion(question, vectorStore)
        st.write(answer)
