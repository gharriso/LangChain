...
modelsArray= {
    ...
    "gpt4": ChatOpenAI(openai_api_key=os.environ["OPENAI_API_KEY"],model_name="gpt-4-turbo",max_tokens=8192),
    "gpt4o": ChatOpenAI(openai_api_key=os.environ["OPENAI_API_KEY"],model_name="gpt-4o",max_tokens=8192),
